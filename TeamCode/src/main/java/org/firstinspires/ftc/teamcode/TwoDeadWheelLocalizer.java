...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1640.890989974137; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 2771.8424994798797; // x position of the perpendicular encoder (in tick units)
    }
