...
@Autonomous (name = "BlueClassifierAuto", group = "Autonomous", preselectTeleOp = "MechaRedTeleOp")
public class BlueClassifierAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder shootOne = drive.actionBuilder(new Pose2d(-12, -52, Math.toRadians(90)))
                ...
                .afterTime(0, io.transfer())
                .waitSeconds(3);
        TrajectoryActionBuilder shootTwo = drive.actionBuilder(new Pose2d(10, -62, Math.toRadians(90)))
                .afterTime(0, io.shoot())
                .splineToLinearHeading(new Pose2d(-22, -16, Math.toRadians(227)),0)
                .afterTime(0, io.intakeRun())
                .afterTime(0, io.transfer())
        ...
        TrajectoryActionBuilder intakeTwo = drive.actionBuilder(new Pose2d(-22, -16, Math.toRadians(227)))
                .splineToLinearHeading(new Pose2d(10, -30, Math.toRadians(90)), 0)
                .waitSeconds(0)
                .lineToYConstantHeading(-62);
        TrajectoryActionBuilder intakeThree = drive.actionBuilder(new Pose2d(-22, -16, Math.toRadians(227)))
                .splineToLinearHeading(new Pose2d(32, -30, Math.toRadians(90)), 0)
                .waitSeconds(0)
                .lineToYConstantHeading(-62)
                .waitSeconds(0)
                .splineToLinearHeading(new Pose2d(-10,-50, Math.toRadians(180)), 0);
