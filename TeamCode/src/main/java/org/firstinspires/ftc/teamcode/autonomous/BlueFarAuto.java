...
@Autonomous (name = "BlueFarAuto", group = "Autonomous", preselectTeleOp = "MechaRedTeleOp")
public class BlueFarAuto extends LinearOpMode {
    ...
    public class IO {
        ...
        public double p = 80, ff = 20, curTargetVelocity = 1225;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder shootPreload = drive.actionBuilder(initialPose)
                ...
                .splineToLinearHeading(new Pose2d(50, -14, Math.toRadians(203)),Math.PI)
                .afterTime(2, io.intakeRun())
                .afterTime(2, io.transfer())
                .waitSeconds(4);
        TrajectoryActionBuilder shootOne = drive.actionBuilder(new Pose2d(34, -62, Math.toRadians(90)))
                .afterTime(0, io.shoot())
                .splineToLinearHeading(new Pose2d(50, -14, Math.toRadians(204)),Math.PI)
                .afterTime(0, io.intakeRun())
                .afterTime(0, io.transfer())
                .waitSeconds(3);
        TrajectoryActionBuilder shootTwo = drive.actionBuilder(new Pose2d(58, -64, Math.toRadians(90)))
                .afterTime(0, io.shoot())
                .splineToLinearHeading(new Pose2d(50, -14, Math.toRadians(205)),Math.PI)
                .afterTime(0, io.intakeRun())
                .afterTime(0, io.transfer())
                .waitSeconds(3);
        TrajectoryActionBuilder intakeOne = drive.actionBuilder(new Pose2d(50, -14, Math.toRadians(200)))
                .splineToLinearHeading(new Pose2d(34, -30, Math.toRadians(90)), Math.PI)
                .waitSeconds(0)
                .lineToYConstantHeading(-62);
        TrajectoryActionBuilder intakeTwo = drive.actionBuilder(new Pose2d(50, -14, Math.toRadians(200)))
                .turnTo(Math.toRadians(90))
                .waitSeconds(0)
                .splineToLinearHeading(new Pose2d(58, -64, Math.toRadians(90)), Math.PI)
                .waitSeconds(0.5);
        TrajectoryActionBuilder intakeThree = drive.actionBuilder(new Pose2d(50, -14, Math.toRadians(200)))
                .turnTo(Math.toRadians(90))
                .waitSeconds(0)
                .splineToLinearHeading(new Pose2d(58, -64, Math.toRadians(90)), Math.PI)
                .waitSeconds(0.5);
