...
@Autonomous (name = "RedBluCruClassifierAuto", group = "Autonomous", preselectTeleOp = "MechaRedTeleOp")
public class RedBluCruClassifierAuto extends LinearOpMode {
    ...
    public class IO {
        ...
        public double p = 80, ff = 20, curTargetVelocity = 1150;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder shootPreload = drive.actionBuilder(initialPose)
                ...
                .splineToLinearHeading(new Pose2d(-22, 16, Math.toRadians(135)),0)
                .afterTime(0, io.intakeRun())
                .afterTime(0, io.transfer())
                .waitSeconds(3);
        TrajectoryActionBuilder shootOne = drive.actionBuilder(new Pose2d(4, 58, Math.toRadians(90)))
                .afterTime(0, io.shoot())
                .splineToLinearHeading(new Pose2d(-22, 16, Math.toRadians(137)),0)
                .afterTime(0, io.intakeRun())
                .afterTime(0, io.transfer())
                .waitSeconds(3);
        TrajectoryActionBuilder shootTwo = drive.actionBuilder(new Pose2d(10, 62, Math.toRadians(270)))
                .afterTime(0, io.shoot())
                .splineToLinearHeading(new Pose2d(-22, 16, Math.toRadians(137)),0)
                .afterTime(0, io.intakeRun())
                .afterTime(0, io.transfer())
                .waitSeconds(3);
        TrajectoryActionBuilder intakeOne = drive.actionBuilder(new Pose2d(-22, 16, Math.toRadians(135)))
                ...
                .waitSeconds(0)
                .splineToLinearHeading(new Pose2d(4, 58, Math.toRadians(90)), 0);
        TrajectoryActionBuilder intakeTwo = drive.actionBuilder(new Pose2d(-22, 16, Math.toRadians(137)))
                .splineToLinearHeading(new Pose2d(10, 30, Math.toRadians(270)), 0)
                .waitSeconds(0)
                .lineToYConstantHeading(62);
        TrajectoryActionBuilder intakeThree = drive.actionBuilder(new Pose2d(-22, 16, Math.toRadians(137)))
                .splineToLinearHeading(new Pose2d(32, 30, Math.toRadians(270)), 0)
                .waitSeconds(0)
                .lineToYConstantHeading(62)
                .waitSeconds(0)
                .splineToLinearHeading(new Pose2d(-10,44, Math.toRadians(180)), 0);
